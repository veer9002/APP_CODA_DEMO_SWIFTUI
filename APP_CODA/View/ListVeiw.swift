...
//  APP_CODA
//
//  Created by Manish  Sharma on 09/03/22.
//
...
struct BasicTextImageRow: View {
    ...
    var body: some View {
        ...
        .alert(isPresented: $showError) {
            Alert(title: Text("Not yet available"), message: Text("Sorry, this feature is not available now. Retry again"), primaryButton: .default(Text("Ok")), secondaryButton: .cancel())
        }
...
struct ListVeiw_Previews: PreviewProvider {
    static var previews: some View {
        ...
        FullImageView(imageName: "Cafe Deadend", location: "Cafe Deadend", type:"Cafe", name: "Hong Kong", isFavorite: .constant(true))
            .previewLayout(.sizeThatFits)
    }
}
